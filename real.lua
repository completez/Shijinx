...
if game.PlaceId == 15049111150 or (Players.LocalPlayer and Players.LocalPlayer:FindFirstChild("leaderstats") and Players.LocalPlayer.leaderstats:FindFirstChild("Damage")) then -- Second Piece
